...
<form action="${pageContext.request.contextPath }/login.jsp" id="login_pt" method="post">
...
<img class="getCodeBtn" style="cursor: pointer; background:#fff; vertical-align:middle"
 src="${pageContext.request.contextPath }/code.jsp" id="VerifyImage2" title="看不清？点击换一个"
 onclick="javascript:this.src='${pageContext.request.contextPath }/code.jsp;'+new Date().getMilliseconds()">
</li>
