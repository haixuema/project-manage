	...
	<div class="page_warp">
		<div class="login_form">
			<div class="login_main l">
				...
				<div class="login_con">
					<form action="${pageContext.request.contextPath }/register.jsp" method="post" id="regForm" class="zj_form" novalidate="novalidate">
						<ul class="reg_box">
							...
							<img class="getCodeBtn" style="cursor: pointer; background:#fff; vertical-align:middle" src="${pageContext.request.contextPath }/code.jsp" id="VerifyImage2" title="看不清？点击换一个" onclick="javascript:this.src='${pageContext.request.contextPath }/code.jsp;'+new Date().getMilliseconds()">
							</div>
							</li>
							<!--
							<li>
