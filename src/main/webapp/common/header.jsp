...
<div class="siteMTopBox">
	<div class="mainInnerBox clearfix relative">
        ...
        <div class="siteHNavBox clearfix">
            ...
            <div class="siteHNavItem">
            	<a href="${pageContext.request.contextPath }/search.jsp?projectType=-1" class="siteHNavItemA">奖励众筹</a>
            </div>
            <div class="siteHNavItem">
            	<a href="${pageContext.request.contextPath }/search.jsp?projectType=1" class="siteHNavItemA">公益众筹</a>
            </div>
            <div class="siteHNavItem">
        ...
        <c:if test="${sessionScope.user != null }">
        <div class="siteHLoginBox clearfix">
        	<a href="${pageContext.request.contextPath }/showPerson.jsp" class="sitehH_login Js_showlogin">个人中心</a>
            <span class="line"></span>
            <a href="logout.jsp" class="siteH_register Js_showRegister">注销</a>
        </div>
        </c:if>
        <!--搜索begin-->
        <div class="siteMSearch siteIlB_box" id="search-box" tabindex="0">
	        <form style="width:100%" method="post" action="${pageContext.request.contextPath }/search.jsp">
