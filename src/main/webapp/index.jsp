 	...
 	<div class="mainInnerBox">
        ...
        <div class="indCardListWrap">
			...
			<div class="indCardItem">
				<a href="project.jsp?id=${gy.get(3).project_id }" class="siteCardItemImgA"><img src="${gy.get(3).img_name }"  alt=""/></a>
			    <div class="indCardICBox">
			    	<div class="indCardICText">
			        	<a href="project.jsp?id=${gy.get(3).project_id }" class="siteCardICH3">${gy.get(3).title }</a>
...
<fmt:formatNumber type="number" var="a" value="${gy.get(3).has_fund_raising/gy.get(3).total_fund_raising*100}" pattern="0.00" maxFractionDigits="2"/>  
			...
			<div class="indCardItem">
				<a href="project.jsp?id=${cb.get(1).project_id }" class="siteCardItemImgA"><img src="${cb.get(1).img_name }" /></a>
			    <div class="indCardICBox">
			    	<div class="indCardICText">
			        	<a href="project.jsp?id=${cb.get(1).project_id }" class="siteCardICH3">${cb.get(1).title }</a>
...
<fmt:formatNumber type="number" var="a" value="${cb.get(1).has_fund_raising/cb.get(1).total_fund_raising*100}" pattern="0.00" maxFractionDigits="2"/> 			            
			...
			<div class="indCardItem">
				<a href="project.jsp?id=${ys.get(2).project_id }" class="siteCardItemImgA"><img src="${ys.get(2).img_name }" /></a>
			    <div class="indCardICBox">
			    	<div class="indCardICText">
			        	<a href="project.jsp?id=${ys.get(2).project_id }" class="siteCardICH3">${ys.get(2).title }</a>
...
<fmt:formatNumber type="number" var="a" value="${ys.get(2).has_fund_raising/ys.get(2).total_fund_raising*100}" pattern="0.00" maxFractionDigits="2"/>			            
        ...
        <!--卡片列表end-->
        <a href="search.jsp" class="indCardListMoreA btn_Alink">浏览更多项目</a>
...
<div class="indexZCWrap">
 	<div class="mainInnerBox">
        ...
        <c:forEach items="${gy }" begin="0" end="2" var="gy1">
			...
			<div class="indCardItem">
				<a href="project.jsp?id=${gy1.project_id }" class="siteCardItemImgA"><img src="${gy1.img_name }"  alt=""/></a>
			    <div class="indCardICBox">
			    	<div class="indCardICText">
			        	<a href="project.jsp?id=${gy1.project_id }" class="siteCardICH3">${gy1.title }</a>
...
<fmt:formatNumber type="number" var="a" value="${gy1.has_fund_raising/gy1.total_fund_raising*100}" pattern="0.00" maxFractionDigits="2"/>			            
        ...
        <!--卡片列表end-->
        <a href="search.jsp?projectType=1" class="indCardListMoreA btn_Alink">浏览更多项目</a>
...
<c:forEach items="${ny}" begin="0" end="2" var="ny1">
			<div class="indCardItem">
            <c:out value="${ny}"/>
				<a href="project.jsp?id=${ny1.project_id}" class="siteCardItemImgA"><img src="${ny1.img_name}" /></a>
			    <div class="indCardICBox">
			    	<div class="indCardICText">
			        	<a href="project.jsp?id=${ny1.project_id }" class="siteCardICH3">${ny1.title}</a>
...
<fmt:formatNumber type="number" var="a" value="${ny1.has_fund_raising/ny1.total_fund_raising*100}" pattern="0.00" maxFractionDigits="2"/>			            
        ...
        <!--卡片列表end-->
        <a href="search.jsp?projectType=2" class="indCardListMoreA btn_Alink">浏览更多项目</a>
...
<div class="indexZCWrap">
  ...
  <c:forEach items="${cb }" begin="0" end="2" var="cb1">   
			<div class="indCardItem">
				<a href="project.jsp?id=${cb1.project_id }" class="siteCardItemImgA"><img src="${cb1.img_name }" /></a>
			    <div class="indCardICBox">
			    	<div class="indCardICText">
			        	<a href="project.jsp?id=${cb1.project_id }" class="siteCardICH3">${cb1.title }</a>
...
<fmt:formatNumber type="number" var="a" value="${cb1.has_fund_raising/cb1.total_fund_raising*100}" pattern="0.00" maxFractionDigits="2"/>			            
        ...
        <!--卡片列表end-->
        <a href="search.jsp?projectType=3" class="indCardListMoreA btn_Alink">浏览更多项目</a>
...
<c:forEach items="${ys }" begin="0" end="2" var="ys1">       
			<div class="indCardItem">
				<a href="project.jsp?id=${ys1.project_id }" class="siteCardItemImgA"><img src="${ys1.img_name }" /></a>
			    <div class="indCardICBox">
			    	<div class="indCardICText">
			        	<a href="project.jsp?id=${ys1.project_id }" class="siteCardICH3">${ys1.title }</a>
...
<fmt:formatNumber type="number" var="a" value="${ys1.has_fund_raising/ys1.total_fund_raising*100}" pattern="0.00" maxFractionDigits="2"/>			            
        ...
        <!--卡片列表end-->
        <a href="search.jsp?projectType=4" class="indCardListMoreA btn_Alink">浏览更多项目</a>
