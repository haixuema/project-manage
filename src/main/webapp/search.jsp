	...
	<div class="searchTBox">
    	<div class="searchTMainBox">
        	<div class="searchB_lib">
            	<label>行业筛选：</label>
                <a href="${pageContext.request.contextPath }/search.jsp" class="">全部</a>
                <a href="${pageContext.request.contextPath }/search.jsp?projectType=1" class="">公益</a>
                <a href="${pageContext.request.contextPath }/search.jsp?projectType=2" class="">农业</a>
                <a href="${pageContext.request.contextPath }/search.jsp?projectType=3" class="">出版</a>
                <a href="${pageContext.request.contextPath }/search.jsp?projectType=4" class="">娱乐</a>
                <a href="${pageContext.request.contextPath }/search.jsp?projectType=5" class="">艺术</a>
                <a href="${pageContext.request.contextPath }/search.jsp?projectType=6" class="">其他</a>
            </div>
            <div class="searchB_lib">
            	<label>项目进程：</label>
